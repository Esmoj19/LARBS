...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/rainbowhxch/dotfiles.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/rainbowhxch/rainbow-LARBS/master/progs.csv"
...
welcomemsg() { \
    dialog --title "Welcome!" --msgbox "Welcome to RainbowCh's Auto-Rice Bootstrapping Script(create by Luke Smith)!\\n\\nThis script will automatically install a fully-featured Linux desktop, which I use as my main machine.\\n\\n-Luke" 10 60
