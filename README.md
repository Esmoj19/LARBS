# RainbowCh's Auto-Rice Bootstraping Scripts

Forked from [Luke's Auto-Rice Bootstraping Scripts (LARBS)](https://github.com/LukeSmithxyz/LARBS), changed to fit me.
...
```
curl -LO esmoj19/resource/larbs.sh
sh larbs.sh
```
